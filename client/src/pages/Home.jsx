    ...
    <>
          <div>
            <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
              ...
              Dhanraj's Estate is the best place to find your next perfect place to live.
              <br/>
              We have a wide range of properties for you to choose from.
            </div> 
            <Link to={`/search`} className='text-xs sm:text-sm text-blue-800 font-bold hover:run'>Let's get started</Link>
                ...
                }
                {
                  saleListings && saleListings.length >0 && (
                    <div className=''>
                      <div className='my-3'>
                        <h2 className='text-2xl font-semibold text-slate-600'>Recent places for rent</h2>
                        <Link to={`/search?type=sale`} className='text-sm text-blue-800 hover:underline'>Show more places for rent</Link>
